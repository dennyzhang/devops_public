...
```
# denny@dennyzhang.com:/opt/couchbase/# python /usr/sbin/node_usage.py
{"hostname": "do-cb-01", "cpu_count": 12, "ram": {"used_percentage": "96.98%(30.47gb/31.42gb)", "ram_buffers_gb": "0.08", "ram_available_gb": "0.57", "ram_total_gb": "31.42", "ram_used_gb": "30.47"}, "ipaddress_eth0": "165.227.9.21", "disk": {"disk_0": {"free_gb": "91.19", "total_gb": "314.87", "partition": "/", "used_percentage": "66.91%", "used_gb": "210.68"}, "free_gb": "91.19", "total_gb": "314.87", "used_percentage": "/ 66.91%(210.68gb/314.87gb)", "used_gb": "210.68"}, "cpu_load": "0.28 0.51 0.50 2/440 9653"}
```

# Usage: get more status: tail log files, and service status
```
# denny@dennyzhang.com:/opt/couchbase/# python /usr/sbin/node_usage.py --check_service_command "service couchbase-server status" --log_file /var/log/syslog
